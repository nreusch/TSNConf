...
python -m main testcases/ra/journal/generated/{tc_name}.flex_network_description --mode CP_ROUTING_CP_SCHEDULING_EXT --no_security --no_redundancy --timeout_routing 3600 --timeout_scheduling 3600 --no_extensibility_optimization --aggregate results_raandext_noext.csv
""")
    f.close()
